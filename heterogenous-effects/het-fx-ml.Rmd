---
title: "Machine Learning for Effect Heterogeneity"
author: "Cyrus Samii"
date: "`r Sys.Date()`"
output: 
  pdf_document:
...
Below are notes on machine learning approaches to addressing effect heterogeneity. The methods are reviewed in light of the goals in the paper, Gechter et al. (2019, [arxiv](https://arxiv.org/abs/1806.07016)).  It would be worth becoming familiar with that paper before reviewing what I have below.
